...
class OpenAIService:
    ...
    async def analyze_with_assistant(
        ...
        prompt = create_analysis_prompt(
            ...
            full_name=full_name,
            consciousness_number=analysis_data['calculations']['consciousness_number'],
            action_number=analysis_data['calculations']['action_number'],
            name_number=analysis_data['calculations'].get('name_number'),
            matrix_data=analysis_data['matrix'],
            interpretations=analysis_data['interpretations'],
            exceptions=analysis_data['exceptions']
        )
